...
// 取得遠端資料
const [{ data: roomsList }, { data: newsList }, { data: culinaryList }] =
  await Promise.all([
    useFetch(`/rooms/`, {
      baseURL: apiBaseUrl,
  ...
  <main class="overflow-hidden">
      ...
      >
        ...
        <div class="room-intro-content text-neutral-0">
          ...
          <div class="d-flex justify-content-end">
            <button
              class="bg-transparent text-primary-100 icon-link icon-link-hover border-0 button-prev"
              type="button"
              @click="slidePrev"
            >
              <Icon
            ...
            <button
              class="bg-transparent text-primary-100 icon-link icon-link-hover border-0 button-next"
              type="button"
              @click="slideNext"
            >
              <Icon
    ...
    <section class="delicacy position-relative py-20 py-md-30 bg-primary-10">
      <div class="container">
        ...
        <div class="row flex-nowrap overflow-x-auto draggable-container">
          <div
