          ...
          <div class="d-flex flex-column gap-6">
            <div>
              ...
              <span class="text-neutral-0 fw-bold">{{
                bookingResultList.userInfo.name
              }}</span>
            </div>
            <div>
              <p class="mb-2 text-neutral-40 fw-medium">手機號碼</p>
              <span class="text-neutral-0 fw-bold">{{
                bookingResultList.userInfo.phone
              }}</span>
            </div>
            <div>
              <p class="mb-2 text-neutral-40 fw-medium">電子信箱</p>
              <span class="text-neutral-0 fw-bold">{{
                bookingResultList.userInfo.email
              }}</span>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-md-5">
          ...
          >
            ...
            <img
              ...
              :src="bookingResultList.roomId.imageUrl"
              :alt="bookingResultList.roomId.name"
            />
            ...
            <section class="d-flex flex-column gap-6">
              ...
              >
                <p class="mb-0">
                  {{ bookingResultList.roomId.name }}，{{
                    countDateDiffs(
                      bookingResultList.checkInDate,
                      bookingResultList.checkOutDate
                    )
                  }}
                  晚
                </p>
                ...
                />
                <p class="mb-0">
                  住宿人數：{{ bookingResultList.peopleNum }} 位
                </p>
              </h3>
              ...
              <div class="text-neutral-80 fs-8 fs-md-7 fw-bold">
                <p class="title-deco mb-2">
                  入住：<span
                    v-timeFormat="bookingResultList.checkInDate"
                  ></span
                  >，15:00 可入住
                </p>
                <p class="title-deco mb-0">
                  退房：<span
                    v-timeFormat="bookingResultList.checkOutDate"
                  ></span
                  >，12:00 前退房
                </p>
              </div>
              ...
              <p class="mb-0 text-neutral-80 fs-8 fs-md-7 fw-bold">
                ...
                {{
                  $formatPrice(
                    bookingResultList.roomId.price *
                      countDateDiffs(
                        bookingResultList.checkInDate,
                        bookingResultList.checkOutDate
                      )
            ...
            <section>
              ...
              >
                <li
                  ...
                  v-for="facility in bookingResultList.roomId.facilityInfo"
                  :key="facility.title"
                >
                  <Icon
                    class="fs-5"
            ...
            <section>
              ...
              >
                <li
                  class="flex-item d-flex gap-2"
                  v-for="amenity in bookingResultList.roomId.amenityInfo"
                  :key="amenity.title"
                >
                  <Icon
                    class="fs-5"
