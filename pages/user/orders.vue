          ...
          >
            ...
            >
              <Icon
                class="fs-5"
                :class="
                  facility.isProvide ? 'text-primary-100' : 'text-neutral-60'
                "
                :icon="
                  facility.isProvide
          ...
          <div class="d-flex flex-column flex-lg-row gap-6">
            ...
            <section class="d-flex flex-column gap-4">
              ...
              <div class="text-neutral-80 fs-8 fs-md-7 fw-medium">
                ...
                <p>
                  <span v-timeFormat="booking.checkInDate"></span>，15:00可入住
                </p>
                <p class="title-deco mb-0">退房：</p>
                <p>
                  <span v-timeFormat="booking.checkOutDate"></span>，12:00前退房
                </p>
              </div>
              <p class="mb-0 text-neutral-80 fs-8 fs-md-7 fw-bold">
                NT$
