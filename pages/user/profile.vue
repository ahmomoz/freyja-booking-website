...
watch(
  ...
  ({ year, month, day }) => {
    if (year && month && day) {
      userData.value.birthday = `${year}-${String(month).padStart(
        2,
        "0"
          ...
          <div class="d-flex flex-column gap-4 gap-md-6">
            ...
            >
              <div>
                ...
                />
                <VErrorMessage name="舊密碼" class="invalid-feedback" />
              </div>
              ...
              <div>
                ...
                />
                <VErrorMessage name="新密碼" class="invalid-feedback" />
              </div>
              ...
              <div>
                ...
                <VField
                  ...
                  name="確認新密碼"
                  class="form-control p-4 fs-7 rounded-3"
                  :class="{ 'is-invalid': errors['確認新密碼'] }"
                  placeholder="請再輸入一次新密碼"
                  rules="required||password"
                  v-model="checkPassword"
                />
                <VErrorMessage name="確認新密碼" class="invalid-feedback" />
              </div>
            </div>
